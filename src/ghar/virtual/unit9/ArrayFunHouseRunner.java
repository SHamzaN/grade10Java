...
public class ArrayFunHouseRunner
{
    public static void main( String args[] )
    {
        ...
        System.out.println("number of 4s  =  " + ArrayFunHouse.getCount(one,4));
        System.out.println("number of 9s  =  " + ArrayFunHouse.getCount(one,9));
        System.out.println("number of 7s  =  " + ArrayFunHouse.getCount(one,7));
        ...
        System.out.println("number of 0s  =  " + ArrayFunHouse.getCount(two,0));
        System.out.println("number of 3s  =  " + ArrayFunHouse.getCount(two,3));
        System.out.println("number of 7s  =  " + ArrayFunHouse.getCount(two,7));
