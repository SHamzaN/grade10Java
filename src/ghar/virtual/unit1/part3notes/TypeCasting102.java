...
// This program demonstrates type casting between the different data types int, double, and char.
...
public class TypeCasting102
{
    public static void main(String[] args)
    {
        ...
        //System.out.println("(int) charVal " + charVal + " becomes " + (int)charVal);
        //System.out.println("(double) charVal " + charVal + " becomes " + (double)charVal);
    }
}